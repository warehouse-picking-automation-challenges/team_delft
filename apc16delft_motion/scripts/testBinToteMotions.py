...
class TestClass:
	...
	def coarse_motion(self, str1, num1, str2, num2, group1, group2):
		rospy.wait_for_service('/motion_executor/execute_coarse_motion')
		try:
			service = rospy.ServiceProxy('/motion_executor/execute_coarse_motion', ExecuteCoarseMotion)

			req = ExecuteCoarseMotionRequest()
			req.start.group_name = group1
			req.start.type = str1
			req.start.bin_index = num1
			req.target.group_name = group2
...
if __name__ == "__main__":
	...
	print "Starting test"
	tc.move_to_home();
	tc.coarse_motion("home",0,"tote",0,"manipulator_tool0","manipulator_tool0")

#	tc.coarse_motion("home",0,"cam",0)
#	tc.coarse_motion("cam",0,"bin",0)
#	tc.coarse_motion("bin",0,"tote",0)
#	tc.coarse_motion("tote",0,"bin",0)
#	tc.coarse_motion("bin",0,"home",0)
	
	for x in range(0,6):
		print "testing motion from bin number: " + str(x+1)
		tc.coarse_motion("tote",0,"tote",x+1,"manipulator_tool0","manipulator_tool0")	
		tc.coarse_motion("tote",x+1,"tote",0,"manipulator_tool0","manipulator_tool0")	

	for x in range(0,6):
		print "testing motion from bin number: " + str(x+1)
		tc.coarse_motion("tote",0,"tote",x+1,"manipulator_tool0","manipulator_tool1")
		tc.coarse_motion("tote",x+1,"tote",0,"manipulator_tool1","manipulator_tool0")